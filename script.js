...
<body class="home-theme" onload="initMedia()">
    ...
    <div class="container">
        ...
        <div id="profile-block">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <div class="name-and-badges">
                        <div id="profile-name">Tunczzzz</div>
                        <div class="badge-box">
            ...
            <div class="bio-separator">I make games and mod stuff.</div>
            ...
            <div class="profile-footer">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.youtube.com/@Tunczzzzz" target="_blank">
